 ...
 */
final class Version20241124160534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (invoice_id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, time_created DATETIME NOT NULL, INDEX IDX_9065174467B3B43D (users_id), PRIMARY KEY(invoice_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE review (review_id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, product_id INT NOT NULL, description VARCHAR(255) DEFAULT NULL, rating SMALLINT NOT NULL, INDEX IDX_794381C667B3B43D (users_id), INDEX IDX_794381C64584665A (product_id), PRIMARY KEY(review_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (users_id INT AUTO_INCREMENT NOT NULL, username VARCHAR(25) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, time_created DATETIME NOT NULL, phone_number INT DEFAULT NULL, PRIMARY KEY(users_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE invoice ADD CONSTRAINT FK_9065174467B3B43D FOREIGN KEY (users_id) REFERENCES users (users_id)');
        ...
        $this->addSql('ALTER TABLE review ADD CONSTRAINT FK_794381C667B3B43D FOREIGN KEY (users_id) REFERENCES users (users_id)');
